...
export declare const setUserIdChild4Adiscope: (userId: string, child: number) => Promise<boolean>;
...
export declare const showLuckyEvent4Adiscope: () => Promise<boolean>;
export declare const setLuckyEventAppId4Adiscope: (appId: string, pubId: string) => Promise<boolean>;
export declare const setLuckyEventUseSafeAreaWebView4Adiscope: (useSafeArea: boolean) => Promise<boolean>;
export declare const setLuckyEventHashMark4Adiscope: (hashMark: string) => Promise<boolean>;
export declare const setLuckyEventBaseUrl4Adiscope: (baseUrl: string) => Promise<boolean>;
export declare const setLuckyEventExtraParam4Adiscope: (key: string, value: string) => Promise<boolean>;
